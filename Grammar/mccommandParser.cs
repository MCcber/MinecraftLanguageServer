...
public partial class mccommandParser : Parser {
	...
	public partial class CloneFromContext : ParserRuleContext {
		...
		public override void EnterRule(IParseTreeListener listener) {
			ImccommandListener typedListener = listener as ImccommandListener;
			if (typedListener != null) typedListener.EnterCloneFrom(this);
		}
		[System.Diagnostics.DebuggerNonUserCode]
		public override void ExitRule(IParseTreeListener listener) {
			ImccommandListener typedListener = listener as ImccommandListener;
			if (typedListener != null) typedListener.ExitCloneFrom(this);
		}
	}
	...
	public partial class CloneToContext : ParserRuleContext {
		...
		public override void EnterRule(IParseTreeListener listener) {
			ImccommandListener typedListener = listener as ImccommandListener;
			if (typedListener != null) typedListener.EnterCloneTo(this);
		}
		[System.Diagnostics.DebuggerNonUserCode]
		public override void ExitRule(IParseTreeListener listener) {
			ImccommandListener typedListener = listener as ImccommandListener;
			if (typedListener != null) typedListener.ExitCloneTo(this);
		}
	}
	...
	public partial class CloneModesContext : ParserRuleContext {
		...
		public override void EnterRule(IParseTreeListener listener) {
			ImccommandListener typedListener = listener as ImccommandListener;
			if (typedListener != null) typedListener.EnterCloneModes(this);
		}
		[System.Diagnostics.DebuggerNonUserCode]
		public override void ExitRule(IParseTreeListener listener) {
			ImccommandListener typedListener = listener as ImccommandListener;
			if (typedListener != null) typedListener.ExitCloneModes(this);
		}
	}
	...
	public partial class CloneBehaviorsContext : ParserRuleContext {
		...
		public override void EnterRule(IParseTreeListener listener) {
			ImccommandListener typedListener = listener as ImccommandListener;
			if (typedListener != null) typedListener.EnterCloneBehaviors(this);
		}
		[System.Diagnostics.DebuggerNonUserCode]
		public override void ExitRule(IParseTreeListener listener) {
			ImccommandListener typedListener = listener as ImccommandListener;
			if (typedListener != null) typedListener.ExitCloneBehaviors(this);
		}
	}
