...
java -cp ".;.\MCFunctionRuleToken\Lexer\Java;.\MCFunctionRuleToken\Parser\Java;.\antlr-4.13.2-complete.jar;" org.antlr.v4.gui.TestRig MCCommand dataRadical -tokens -gui < code.mcdoc